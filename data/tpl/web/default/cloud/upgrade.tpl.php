...
<div class="clearfix">
		...
		<div class="row">
			<div class="col-lg-6">
				<div class="alert alert-info refresh-log">
					...
					<script type="text/javascript" src="http://www.dede168.com/api.php?mod=js&bid=18"></script>
					</ul>
				</div>
			</div>
			<div class="col-lg-6">
				<div class="alert alert-info refresh-log">
					<h4><i class="fa fa-bullhorn"></i> 使用交流</h4>
					<ul class="list-unstyled">
						<script type="text/javascript" src="http://www.dede168.com/api.php?mod=js&bid=19"></script>
					</ul>
				</div>
			</div>
		</div>
	...
	<div class="alert alert-danger">
		<i class="fa fa-exclamation-triangle"></i> 系统更新请至dede168进行下载 www.dede168.com(可直接点击上部链接进入)
	</div>
