...
//             and title like '%".$search."%'");
            ...
            ".tablename('enjoy_city_firm').") tb where uniacid=".$uniacid." and ischeck=1
                and cnickname like '%".$search."%' order by hot desc");
...
public function doMobilefirmtag(){
 ...
 public function doMobilekfewm(){
    ...
    public function fm_qrcode($value = 'http://www.dede168.com', $filename = '', $pathname = '', $logo = '', $scqrcode = array('errorCorrectionLevel' => 'H', 'matrixPointSize' => '4', 'margin' => '5'))
    {
        global $_W;
