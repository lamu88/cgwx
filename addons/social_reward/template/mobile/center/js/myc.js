...
var myc = (function(){
	//联系客服
	function qq1(){		
		var html = '<div class="fixedQQ" id="fixedQQ" style="position: fixed;right: 10px;top: 60px;width:40px;height:60px;background-image:url(../image/qq.jpg);background-size: 100% 100%; padding: 10px 10px;border-radius: 3px;z-index:999999999"></div>';
		document.body.insertAdjacentHTML('beforeEnd', html);
		document.getElementById("fixedQQ").onclick = function(){
			window.location.href = 'http://wpa.qq.com/msgrd?v=3&uin=' + officialCSQQ;
		}		
	}
	//联系客服
	function qq(){		
		var html = '<div style="position: fixed;right: 10px;top: 78px;z-index:999999999"> <div id="qqbtn" style="background-color: rgba(0,0,0,0.5);padding: 5px 7px;border-radius: 3px;"> <i style="display: inline-block;width: 14px;height: 14px;background-image: url(../image/wx_news.png);background-size: 100% 100%; vertical-align: middle;margin-right: 3px;"></i><span style="color: #fff;vertical-align: middle;">联系客服</span> </div> <div id="qqbtns" style="text-align: center;background-color: rgba(0,0,0,0.5);margin-top: 10px;border-radius: 3px;position: relative;display:none"> <div style="position: absolute;left:50%;top:-10px;-webkit-transform: translateX(-50%);-moz-transform: translateX(-50%);-ms-transform: translateX(-50%);-o-transform: translateX(-50%);transform: translateX(-50%);border-width:5px;border-style: solid;border-color: transparent transparent rgba(0,0,0,0.5) transparent;"></div> <div id="qqfabuzhe" style="color: #fff;line-height: 30px;">联系发布者</div> <div id="qqtaomei" style="color: #fff;line-height: 30px;">联系平台</div> </div> </div>';
		document.body.insertAdjacentHTML('beforeEnd', html);
		document.getElementById("qqbtn").onclick = function(){
			window.location.href = 'http://wpa.qq.com/msgrd?v=3&uin=' + officialCSQQ;
//			var qqbtns = document.getElementById("qqbtns");
//			if(qqbtns.style.display == 'none'){
//				document.getElementById("qqbtns").style.display = 'block';
//			}else{
...
//		}
	...
	function showProgress(obj){
		...
		if(document.getElementById("showProgressContainer")){
			...
			var html = '<div id="showProgressBackground" style="position: fixed;width: 100%;height: 100%;left: 0;top: 0;background-color: rgba(0,0,0,'+ rgba +');z-index:999999"></div><div id="showProgressContainer" style="position: fixed;left: 50%;top: 50%;-webkit-transform:  translateX(-50%) translateY(-50%);-moz-transform:  translateX(-50%) translateY(-50%);-ms-transform:  translateX(-50%) translateY(-50%);-o-transform:  translateX(-50%) translateY(-50%);transform:  translateX(-50%) translateY(-50%);background-color: rgba(0,0,0,1);color: #fff;padding: 15px;border-radius: 5px;text-align: center;min-height: 115px;min-width: 115px;z-index:999999"><div style="display: inline-block;height: 30px;width: 30px;background-image: url(/addons/social_reward/template/mobile/center/image/loading1.gif);background-size: 100% 100%;"></div><div id="showProgressTitle" style="padding: 5px 0;color:#fff"></div><div id="showProgressText" style="color:#fff"></div></div>';
