...
//一元夺宝2.0.1更新
pdo_query("CREATE TABLE IF NOT EXISTS `ims_weliam_indiana_navi` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '唯一标识',
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_weliam_indiana_in` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '唯一标识',
...
//}
pdo_query("CREATE TABLE IF NOT EXISTS `ims_weliam_indiana_syssetting` (
