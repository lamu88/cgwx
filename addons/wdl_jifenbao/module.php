...
define('OB_ROOT', IA_ROOT . '/attachment/wdl_jifenbao');
class Wdl_jifenbaoModule extends WeModule {
    public $reply = 'wdl_jifenbao_poster';
	...
	public function settingsDisplay($settings) {
		...
		if (checksubmit()) {
			...
			$cfg = array(
                'wdl_jifenbao_fansnum'=>$_GPC['wdl_jifenbao_fansnum'],
				'wdl_jifenbao_usr' => $_GPC['wdl_jifenbao_usr'],
