...
function getapplicationFrames(){
	...
	$frames['base']['items']['special']['title'] = '特殊商品';
	$frames['base']['items']['special']['actions'] = array();
	$frames['base']['items']['special']['active'] = '';
	
	$frames['base']['items']['scratch']['url'] = web_url('application/scratch/list');
	$frames['base']['items']['scratch']['title'] = '刮刮卡';
	$frames['base']['items']['scratch']['actions'] = array();
	$frames['base']['items']['scratch']['active'] = '';
...
function get_top_menus(){
	...
	if($_W['isfounder']){
		$frames['system']['title'] = '<i class="fa fa-gear"></i>&nbsp;&nbsp; 系统设置';
