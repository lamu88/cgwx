<?php defined('IN_IA') or exit('Access Denied');?>	<script type="text/javascript">
	...
	<div class="container-fluid footer" role="footer">
		...
		<span class="pull-right">
			<p><?php  if(empty($_W['setting']['copyright']['footerright'])) { ?><a href="http://www.dede168.com">春哥网络</a><a href="http://www.dede168.com">帮助文档</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerright'];?><?php  } ?><?php  if(!empty($_W['setting']['copyright']['statcode'])) { ?>&nbsp; &nbsp; <?php  echo $_W['setting']['copyright']['statcode'];?><?php  } ?></p>
		</span>
	</div>
